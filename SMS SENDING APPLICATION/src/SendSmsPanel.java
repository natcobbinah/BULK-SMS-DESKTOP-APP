...
public class SendSmsPanel extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6003481406975592068L;
	...
	private JComboBox countrycodescbo;
	public JTextField phonenumtxtfd;
	private JComboBox urlcbo;

	private JButton sendbtn;
	private JButton clearbtn;

	// private String userName = "Natcobbinah";
	// private String password = "@BYStrVMH";
	/*
	 * public String userName = "henhak"; public String password =
	 * "3Accountability";
	 */
	...
	private void SendSmsPanelLayoutDesign() {
		...
		String[] countryCodes = { "+93", "+355", "+213", "+684", "+376", "+244", "+809", "+268", "+54", "+374", "+297",
		...
		countrycodescbo = new JComboBox(countryCodes);

		countrycodescbo.setEditable(true);
		...
		recipientPanel.add(countrycodescbo, rgc);

		rgc.gridx = 1;
		rgc.gridy = 0;
		rgc.anchor = GridBagConstraints.NORTHWEST;
		recipientPanel.add(phonenumtxtfd, rgc);
		// -------------------------------------------------------------------

		JPanel allgcPanel = new JPanel();
		allgcPanel.setLayout(new GridBagLayout());
		allgcPanel.setBorder(BorderFactory.createTitledBorder("Send SMS [Single Receipient]"));
		...
		sendbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String phonenumcode = (String) countrycodescbo.getSelectedItem();
				String phonenum = phonenumtxtfd.getText();

				String fullphonenum = phonenumcode + phonenum;

				String url = (String) urlcbo.getSelectedItem();

				smsSample.SendSMS(userName, password, message, fullphonenum, url);
